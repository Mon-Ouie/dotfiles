(defun my-color-theme-charcoal-black ()
  ...
  (color-theme-install
   '(color-theme-charcoal-black
     ...
     (default ((t (:stipple nil :background "black" :foreground "#7f7f7f" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 87 :width semi-condensed :family "misc-fixed"))))
     ...
     (mode-line ((t (:background "#7f7f7f" :foreground "black" :box (:line-width -1 :style released-button)))))
